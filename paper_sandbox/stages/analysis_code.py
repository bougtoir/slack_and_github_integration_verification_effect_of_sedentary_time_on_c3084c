...
def run_generated_analysis(cfg, topic, idea_text, acquired, output_dir, max_attempts=3, client=None):
    ...
    base_prompt = (
        ...
        "- Files may have messy headers (official statistics). Inspect, locate the header row programmatically, "
        "coerce numerics, and drop footnotes. If a file is unusable, skip it and say so in limitations.\n"
